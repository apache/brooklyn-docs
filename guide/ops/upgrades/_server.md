...
2. Upgrade Apache Brooklyn:
   ...
   1. [Download](/guide/misc/download.md) the new RPM/DEB package
...
3. Install new version of Apache Brooklyn:
   ...
   1. [Download](/guide/misc/download.md) the new tarball zip package.
...
* User credentials should now be recorded in [`brooklyn.cfg`](/guide/ops/configuration/brooklyn_cfg.md).

* Brooklyn will still read them from both [`brooklyn.cfg`](/guide/ops/configuration/brooklyn_cfg.md) and `~/.brooklyn/brooklyn.properties`.

* Configure a username/password by modifying [`brooklyn.cfg`](/guide/ops/configuration/brooklyn_cfg.md). An example entry is:
...
* [`brooklyn.cfg`](/guide/ops/configuration/brooklyn_cfg.md)
* [`org.apache.brooklyn.osgilauncher.cfg`](/guide/ops/paths.md)

For example, to use S3 for the persisted state, add the following to [`brooklyn.cfg`](/guide/ops/configuration/brooklyn_cfg.md):
...
To continue the S3 example, for the persisted state, add the following to [`org.apache.brooklyn.osgilauncher.cfg`](/guide/ops/paths.md):
...
0.12.0 versions. Assuming Brooklyn has been installed to [`/opt/brooklyn`](/guide/ops/paths.md) (as is done by the RPM and DEB):
