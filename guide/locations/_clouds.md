...
If you prefer to keep the credentials separate, you can instead store them as a [catalog entry](/guide/blueprints/catalog/index.html#locations-in-catalog) or set them in `brooklyn.properties` 
...
This location will be saved as a [catalog entry](/guide/blueprints/catalog/index.html#locations-in-catalog) for easy reusability.
